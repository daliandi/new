...
| Antigravity IDE 已安装 | 打开 Antigravity IDE | 版本要求：最新稳定版 |
...
# 验证模板文件已就绪
ls -la
# 应该看到：.antigravity/  harness-collab/  config/  pom.xml  README.md  AGENTS.md
```
...
```bash
# 验证关键目录和文件存在
ls .antigravity/steering/    # 应该看到 5 个 .md 文件
ls .antigravity/hooks/       # 应该看到 4 个 .md 文件
...
├── .antigravity/                       ← Harness steering 和 hooks
...
### 步骤 4：在 Antigravity 中打开工作区，验证 steering 文件已加载

1. 打开 Antigravity IDE
2. 选择"打开文件夹"，选择工作区根目录（`my-workspace/`）
3. 等待 Antigravity 加载工作区
4. 验证 steering 文件已加载：
...
5. 向 Antigravity 发送测试消息，验证约束已生效：
...
```
=== Harness 模板完整性验证 ===
✅ .antigravity/steering/java-engineering-standards.md
✅ .antigravity/steering/testing-quality-standards.md
✅ .antigravity/steering/api-doc-sync-protocol.md
✅ .antigravity/steering/ai-collaboration-protocol.md
✅ .antigravity/steering/project-lifecycle.md
✅ .antigravity/hooks/api-doc-sync-check.md
✅ .antigravity/hooks/layer-constraint-check.md
✅ .antigravity/hooks/test-coverage-reminder.md
✅ .antigravity/hooks/maven-profile-check.md
...
✅ Harness 模板完整性验证通过
```
...
### Q3：Antigravity 没有自动加载 steering 约束
...
head -5 .antigravity/steering/java-engineering-standards.md
# 应该看到：
# ---
# inclusion: auto
# ---

# 重新打开工作区（关闭 Antigravity 后重新打开工作区根目录）
```
