...
public class DroneController {
    ...
    @ResponseBody
    public List<Drone> apiSearch(@RequestParam String keyword) {
        return droneService.search(keyword);
    }
    ...
    @PostMapping("/api")
    @ResponseBody
    public Object apiSave(@Valid @RequestBody Drone drone, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
